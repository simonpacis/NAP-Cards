...
function menu:draw()
	...
	love.graphics.print( strings['menu']['gamename'], 10, (height-50))
    love.graphics.print( strings['menu']['version'], 10, (height-30))
    love.graphics.print( strings['menu']['welcome'] .. username .. ".", 10, 20)
    love.graphics.print( strings['menu']['statistics']['stats'], 10, 80)
    love.graphics.print( strings['menu']['statistics']['wins']..userstats['wins'], 10, 100)
    love.graphics.print( strings['menu']['statistics']['losses']..userstats['losses'], 10, 120)
    love.graphics.print( strings['menu']['statistics']['leggies']..tostring(tablelength(userstats['leggies'])), 10, 140)
    love.graphics.setFont(zombie)
